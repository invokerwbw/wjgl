...
$(document).ready(function() {
	...
	var msg1 = L.getLocaleMessage("bsp.user.052","用户管理");
	var msg2 = L.getLocaleMessage("bsp.user.053","编辑用户");
	var msg3 = L.getLocaleMessage("bsp.user.054","增加用户");
	if (check != null && check != undefined && check != '') {
		$("#bread").append('<a href="' + context + '/service/bsp/user/">'+msg1+'</a> > '+msg2);
		status = "edit";
		...
		$("#bread").append('<a href="' + context + '/service/bsp/user/">'+msg1+'</a> > '+msg3);
		status = "new";
	}
