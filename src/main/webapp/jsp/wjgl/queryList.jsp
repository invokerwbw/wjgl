...
<link href="../../skins/skin/css/wjgl/paper.css" rel="stylesheet"
	type="text/css">
<link href="../../skins/skin/css/wjgl/search.css" rel="stylesheet"
	type="text/css">
<script type="text/javascript" src="${ctx}/skins/wjgl/queryList.js"></script>
</head>
<body>
	<div class="container">
		<form id="searchForm" class="form-inline" onsubmit="return false;">
			<table class="bzcxTable">
				<tr>
					<td colspan="12"><input id="keyword" name="keyword" type="text"
						class="form-control ue-form" value="" placeholder="请输入标准号或标准名称" /></td>
					<td><span>&nbsp;&nbsp;标准组织&nbsp;&nbsp;</span></td>
					<td><select class="form-control ue-form" id="bzzz" name="bzzz"
						style="width: 180px">
					...
					<td><div class="input-group date" id="fbrqqDiv">
							<div id="fbrqstart">
								<input type="text" class="form-control ue-form"
									style="width: 120px" name="fbrqq" id="fbrqq"
									readonly="readonly" />
							</div>
					...
					<td>&nbsp;&nbsp;至&nbsp;&nbsp;</td>
					<td><div class="input-group date" id="fbrqzDiv">
							<div id="fbrqend">
								<input type="text" class="form-control ue-form"
									style="width: 120px" name="fbrqz" id="fbrqz"
									readonly="readonly" />
							</div>
							<span class="input-group-addon ue-form-btn"><i
								class="fa fa-calendar"></i></span>
						</div></td> -->
						<td colspan="2"><span>&nbsp;&nbsp;标准状态&nbsp;&nbsp;</span><input
						type="checkbox" class="check" id="xianxing" name="a200s"
						value="现行"> <label for="xianxing">现行 </label> <input
						type="checkbox" class="check" id="weishengxiao" name="a200s"
						value="未生效"> <label for="weishengxiao">未生效 </label> <input
						type="checkbox" class="check" id="feizhi" name="a200s" value="废止">
						<label for="feizhi">废止</label></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="5"><button type="button"
							class="btn ue-btn searchBtn" id="searchBtn">
