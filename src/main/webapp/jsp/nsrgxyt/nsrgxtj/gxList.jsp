...
<script type="text/javascript"
	src="${ctx}/jsp/nsrgxyt/nsrgxtj/gxList.js"></script>
<style type="text/css">
.jbxxTable {
...
<body>
	<div class="container">
			...
			<div style="border: 1px solid #e7e7e7;">
				<table class="jbxxTable">
					...
					<tr>
						<td></td>
						<td>关系区域范围：</td>
						<td><select class="form-control ue-form" id="gxqyfw"
							name="gxqyfw" style="width: 180px">
								<option value="">请选择</option>
						</select></td>
						<td></td>
						<td>关系时间范围：</td>
						<td><input type="text" class="s-ue-form" id="gxsjfwq"
							name="gxsjfwq" /><span>&nbsp;-&nbsp;</span><input type="text"
							class="s-ue-form" id="gxsjfwz" name="gxsjfwz" /><span>&nbsp;（月）&nbsp;</span></td>
						<td></td>
					</tr>
					<tr>
						<td></td>
		...
		<table id="gxList" class="table table-bordered table-hover">
			<thead>
				<tr>
